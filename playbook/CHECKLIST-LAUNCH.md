# Launch Checklist (canonical)

Use this before you tell the client the site is live. Kit-specific extras are in each starter's `CHECKLIST.md`.
...
- [ ] About text is accurate (no placeholder lorem ipsum)
...
- [ ] Brand colors match client request

---

## Pages & links

- [ ] All pages load (Home, About, Services, Contact — or kit equivalent)
...
- [ ] Client received test message (check spam)
...
- [ ] GitHub Pages (or Netlify / Wix publish) enabled
